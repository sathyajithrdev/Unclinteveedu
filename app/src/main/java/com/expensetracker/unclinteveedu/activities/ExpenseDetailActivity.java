...
public class ExpenseDetailActivity extends BaseActivity implements View.OnClickListener, PhoneFeaturePermissionHelper.PhoneFeaturePermission {
...
//                showAlert(getString(R.string.error_add_expense), true);
                showAlert(exception.getMessage(), true);
                hidProgress();
            }
